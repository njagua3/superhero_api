...
Revision ID: 068a81842943
Revises: 
Create Date: 2024-10-07 20:30:32.971859
...
def upgrade():
    ...
    sa.CheckConstraint('length(description) >= 20', name='check_description_length'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.CheckConstraint("strength IN ('Strong', 'Weak', 'Average')", name='check_strength_value'),
